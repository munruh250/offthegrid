...
public static class Harvest
{
    ...
    public static float SkillMultiplierFor(Activity activity, int attribute) => activity switch
    {
        ...
        // One draw with a line, two with a net - so skill moves it more than
        // gathering, less than a stalk.
    ...
    {
        // [Q1 ANSWERED] Fishing is its OWN attribute. Design spec 4.1 folded it
        // into Hunting and flagged the split; Hunting was governing three of four
        // food routes against Foraging's one, and two contestants on identical
        // loadouts differed 22% to 3% on nothing but Hunting 6 against Hunting 3.
        Activity.Fishing => AttributeKind.Fishing,
